...
const markdownComponents: Components = {
  ...
  img: ({
    ...
    const imgProps = props as React.ComponentProps<"img">;
    return (
      <>
        {/* biome-ignore lint/performance/noImgElement: Markdown img */}
        <img
          alt={imgProps.alt || ""}
          className="my-10 w-full rounded-3xl bg-foreground/5 object-cover"
          {...imgProps}
        />
      </>
    );
