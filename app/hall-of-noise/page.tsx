...
export default function HallOfNoiseComingSoon() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        initial={
          prefersReducedMotion ? { opacity: 0.6 } : { opacity: 0.4, scale: 0.9 }
        }
        animate={
          prefersReducedMotion
            ? { opacity: 0.6 }
            : { opacity: [0.35, 0.55, 0.4], scale: [0.96, 1.04, 0.98] }
        }
        transition={
          prefersReducedMotion
            ? { duration: 0 }
      ...
      <motion.div
        ...
        animate={
          prefersReducedMotion
            ? { opacity: 0.6 }
            : { opacity: [0.35, 0.5, 0.38], scale: [0.94, 1.06, 0.98] }
        }
        transition={
          prefersReducedMotion
            ? { duration: 0 }
            : { duration: 14, repeat: Infinity, ease: "easeInOut", delay: 1.2 }
        }
